...
const WhatsAppFloat = () => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
    >
      <span className="absolute w-14 h-14 rounded-full bg-whatsapp animate-ping opacity-50" />
      <span className="relative w-14 h-14 bg-whatsapp rounded-full flex items-center justify-center shadow-lg">
