        ...
        <div className="grid md:grid-cols-2 gap-12 items-start max-w-4xl mx-auto">
          ...
          <div className="bg-secondary rounded-2xl p-8 md:p-10 text-center">
            ...
            <a
              ...
              className="bg-whatsapp text-accent-foreground font-heading font-bold text-lg px-8 py-4 rounded-lg hover:opacity-90 transition-all shadow-lg inline-flex items-center justify-center gap-2 w-full"
            >
