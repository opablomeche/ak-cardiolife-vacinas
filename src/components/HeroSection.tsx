...
const HeroSection = () => {
  return (
    <section
      id="inicio"
      className="relative bg-section-warm overflow-hidden"
    >
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* Text */}
          <div className="order-2 lg:order-1">
            <span className="inline-flex items-center gap-2 bg-primary/10 text-primary text-sm font-heading font-semibold px-4 py-1.5 rounded-full mb-6 border border-primary/20">
              <span className="w-2 h-2 rounded-full bg-primary" />
              Centro de Vacinação Especializada
            </span>

            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-extrabold text-secondary leading-tight mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#vacinas"
                className="bg-primary text-primary-foreground font-heading font-bold text-lg px-8 py-4 rounded-lg hover:opacity-90 transition-all shadow-lg hover:shadow-xl inline-flex items-center justify-center"
              >
              ...
              <a
                ...
                className="bg-accent text-accent-foreground font-heading font-bold text-lg px-8 py-4 rounded-lg hover:opacity-90 transition-all shadow-lg inline-flex items-center justify-center gap-2"
              >
